...
function Settings() {
    const { state: { user, userConfig }, updateUserAttributes, } = useAuth();
        ...
        <div>
          <div className="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div className="mt-5 md:mt-0 md:col-span-2">
              <ProfileForm user={user} userConfig={userConfig} updateUserAttributes={updateUserAttributes}/>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6">
                      <div className="mt-5 border-t border-gray-200">
                        <SecurityTable email={user?.email} userConfig={userConfig}/>
                      </div>
                    </div>
                  </div>
                </div>
