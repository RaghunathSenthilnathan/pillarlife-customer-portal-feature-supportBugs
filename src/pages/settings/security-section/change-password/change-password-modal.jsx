...
export function ChangePasswordModal({ userConfig, showsPasswordModal, closePasswordModal, }) {
    ...
    return (<Modal title="Change Password" description="Pick a strong password of minimum 6 characters, that you haven't used on any other website." showsModal={showsPasswordModal} closeModal={closePasswordModal} icon={<LockIconColored className="w-12 h-12"/>} body={<ChangePasswordForm register={register} handleSubmit={handleSubmit} formErrors={formErrors} isLoading={isLoading} newPasswordRef={newPasswordRef}/>}/>);
}
