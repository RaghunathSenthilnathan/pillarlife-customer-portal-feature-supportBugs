...
const url = `${process.env.FRONTEND_BASE_URL}${ROUTE_PATHS.ADD_CONTINGENT_BENEFICIARY}`;
const title = "Add Contingent Beneficiary";
const description =
...
const addcontingentbeneficiary = () => {
  ...
  const [benefic, setContiBeneficiary] = useState();
  ...
  function postdata(item) {
    ...
    ContingentData.id = uuidv1();
   
    allstoredbeneficiary.push(ContingentData);
  ...
  const header = (
    <div className="flex justify-between p-4">
      {" "}
      <div>
        <h2 className="ml-0 sm:ml-5 font-bold text-blue-800">
  ...
  const title = (
    <Container>
      The contingent beneficiary details have been added successfully.
    </Container>
  );
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="flex flex-row justify-between mb-7 space-x-35">
                <div className="font-bold text-lg text-blue-800">
                  ...
                  {/* <Grid className="grid grid-cols-3  pr-2 mb-3">
                    ...
                    <div className=" col-span-1 w-4/12 ml-72 mt-1 p-field-radiobutton radio-border h-11  ">
                      <RadioButton
                      ...
                      />
                      <label htmlFor="yes" className="p-2 text-black">
                        Person
                      </label>
                    </div>

                    <div className=" col-span-1 w-4/12 mt-1 p-field-radiobutton ml-3 radio-border h-11 ml-0 sm:ml-36 ">
                      <RadioButton
                        inputId="benePartyType"
                        name="benePartyType"
                        value="Trust"
                        ...
                        onBlur={formik.handleBlur}
                      />
                      <label htmlFor="no" className="p-2 text-black">
                        Trust
                      </label>
                    </div>
                  </Grid> */}
                  ...
                  <Card className="prim-beneficiary border-transparent">
                    <div className="ml-0 sm:ml-5">
                      ...
                      <Grid className="grid-cols-3 gap-4 mt-0 sm:mt-5 pr-5">
                        <Container className="col-span-3 sm:col-span-1">
                          <Container className="grid-rows-2">
                            <Label
                              htmlFor="benePhone"
                        ...
                        <div className="col-span-2 sm:col-span-1 text-black p-1 text-md px-0 sm:px-2 font-semibold">
                          <Grid className="grid grid-cols-2 ml-0 sm:ml-16 sm:pr-1">
                            <div className=" col-span-1 sm:col-span-1 w-3/4 sm:w-6/12 mt-3 p-field-radiobutton radio-border h-11 ml-0 sm:ml-32  ">
                              {/* <div className=" col-span-1 w-4/12 ml-1 p-field-radiobutton radio-border h-11 ml-0 sm:ml-72"> */}
                              <RadioButton
              ...
              <Flex
                ...
                className="border1 flex-col-reverse md:flex-row ml-0 pl-0 sm:pl-55 items-center justify-center space-y-3 sm:justify-between border-gray-400 mt-10 sm:mt-5 mb-5 h-15 ml-0 sm:ml-3 pt-5 sm:pt-0"
              >
                <NextLink
...
export default withAuthentication(addcontingentbeneficiary);
