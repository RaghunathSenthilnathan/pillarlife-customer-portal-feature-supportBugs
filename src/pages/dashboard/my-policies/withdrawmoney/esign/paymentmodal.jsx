...
export function PaymentModal({
  ...
  useEffect(() => {
    ...
    user &&
      user.map((item) => {
        if (item.name === "Plaid Checking" || item.name === "Plaid Saving") {
          accounts.push(item);
        }
      });
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-row font-muli space-x-16">
                    <div className="flex flex-col   space-y-1 mt-2">
                      <div className="text-black text-md font-muli font-bold">
                        {" XXX" + "-" + "XXXX" + "-" + item.mask}
                      </div>
                      <div className="text-gray-500 text-left text-sm font-semibold">
                        {item.name}
                      </div>
                    </div>
                  </div>
