...
const policyCardForTrust = value => {
            ...
            <div className="card p-4">
              <div className="flex flex-row space-x-10 sm:divide-x-2 divide-gray-300">
                ...
                <div className="flex p-0 sm:p-4 place-items-center">
                  <NextLink
                    href={`/dashboard/my-policies/updatebeneficiary?id=${item.characteristics[item.characteristics.length-1].policyLocator}`}
                  >
                    <div>
...
export default policyCardForTrust;
