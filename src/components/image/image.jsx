 ...
 */
export const Image = ({ src, alt, aspectRatio = 16 / 9, className = '', ...rest }) => (<div className="relative" style={{
        paddingBottom: `${(1 / aspectRatio) * 100}%`,
    }}>
    <div className="absolute inset-0">
      <img src={src} alt={alt} className={`${className} w-full h-full object-cover`} {...rest}/>
    </div>
  </div>);
